...
const accountNotExist = (rule, value, callback) => {
    bears.api.getAccounts([value], (err, result) => {
        if (result[0]) {
 ...
 * See
 * https://github.com/bearshares/condenser/blob/eaf8a02658b8deaef376ec90b81d0866e52582cc/app/utils/ChainValidation.js#L4
 *
 * @param {string} name
 * @return {boolean}
 */
